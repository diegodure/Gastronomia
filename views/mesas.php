						...
						<div class="table-responsive">
							<table class="table">
								...
								<tr ng-repeat="mesa in mesas | orderBy:ordenSeleccionado | filter:buscar">
									...
									<a href="#" class='btn btn-sm btn-warning' title='Editar mesa' ng-click="modificar(mesa)" data-toggle="modal"><i class="glyphicon glyphicon-edit"></i></a> 
									<a href="#" class='btn btn-sm btn-danger' title='Borrar mesa' ng-click="eliminar(mesa)"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
								</tr>
